...
class ShowHospital : AppCompatActivity() {

    private var database: FirebaseDatabase? = null
    private var ref: DatabaseReference? = null

    private var adapter:HospitalAdapter?=null
    private var list: ArrayList<Hospital>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mDatabaseRef = FirebaseDatabase.getInstance().getReference("hospital")
        ...
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (data in dataSnapshot.children) {
                    ...
                    val models: Hospital? = data.getValue(Hospital::class.java)
                    println(models)
                    if (models != null) {
                        list!!.add(models)
                    }
                ...
                adapter = HospitalAdapter(list,applicationContext)
