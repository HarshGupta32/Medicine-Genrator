...
class medicinelocation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medicinelocation)

        val btndeatils = findViewById<Button>(R.id.btndetails)

        btndeatils.setOnClickListener {
            val intent = Intent(applicationContext, Showmedicine::class.java)
        ...
        task.addOnSuccessListener { location ->
            if (location != null) {
                ...
                supportMapFragment!!.getMapAsync { googleMap ->
                    map = googleMap
                    mfire = FirebaseDatabase.getInstance().reference.child("medicine")
