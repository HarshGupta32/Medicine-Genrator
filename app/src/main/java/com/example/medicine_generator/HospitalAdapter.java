...
public class HospitalAdapter extends RecyclerView.Adapter<HospitalAdapter.ViewHolder> {
    ArrayList<Hospital> mList;
    Context context;

    public HospitalAdapter(ArrayList<Hospital> mList, Context context) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Hospital vacancy1 = mList.get(position);
        ...
        holder.txtadd.setText("Specification -"+vacancy1.getTreatment());
        holder.txtarea.setText("Date -"+vacancy1.getTreatment());
