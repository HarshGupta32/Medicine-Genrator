...
public class DoctorAdapter extends RecyclerView.Adapter<DoctorAdapter.ViewHolder> {
    ...
    public DoctorAdapter(ArrayList<Doctor> mList, Context context) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Doctor vacancy1 = mList.get(position);
        ...
        holder.txtadd.setText("Soecification -"+vacancy1.getSpe());
        holder.txtarea.setText("Date -"+vacancy1.getDate());
