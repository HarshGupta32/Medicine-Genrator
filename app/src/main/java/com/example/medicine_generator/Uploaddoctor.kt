...
class Uploaddoctor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_uploaddoctor)
    ...
    fun UploadData(view: View?) {
        ...
        val data = FirebaseDatabase.getInstance().reference.child("doctor")
        val service = Doctor(category,address,description,price,medicine,lati,longi)
